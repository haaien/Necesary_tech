...
public class TranceActivityEightPer extends AppCompatActivity {
    ...
    protected  void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.trance_tech_5);
        Intent intent = getIntent();
        int acceptpoints = intent.getIntExtra(TranceActivitySixPer.SEND_POINT, 0);
        points = acceptpoints;
        //ボタンを押した際にカウントを増やし、一定値以上で切り替える
        final TextView textview = (TextView) findViewById(R.id.scoreText);
        Button button1 = (Button) findViewById(R.id.buttonFifth);
        ...
        button1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                textview.setText(String.valueOf(points));
                if(points >= 20){
                    Intent intent = new Intent(getApplication(), TmpStab.class);
