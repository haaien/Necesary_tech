...
public class TranceActivityTwoPer extends AppCompatActivity {
    ...
    protected  void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.trance_tech_2);
        Intent intent = getIntent();
        int acceptpoints = intent.getIntExtra(TranceActivity.SEND_POINT, 0);
        points = acceptpoints;
        //ボタンを押した際にカウントを増やし、一定値以上で切り替える
        final TextView textview = (TextView) findViewById(R.id.scoreText);
        Button button1 = (Button) findViewById(R.id.buttonSecond);
        ...
        button1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                textview.setText(String.valueOf(points));
                if(points >= 8){
                    Intent intent = new Intent(TranceActivityTwoPer.this, TranceActivityFourPer.class);
